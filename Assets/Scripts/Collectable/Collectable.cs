...
public class Collectable : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Explode();
        FlashVfxCompleted();
        StartCoroutine(DisapearNoticeCountDown());
    }

    private IEnumerator DisapearNoticeCountDown()
    {    
    ...
    public void OnDestroyCollectable()
    {
        Destroy(gameObject);
    }
    private void Explode()
    {
        ...
        m_rb.velocity=new Vector2(randomForceY, randomForceX)*Time.deltaTime;
